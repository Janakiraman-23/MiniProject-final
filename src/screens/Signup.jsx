...
export default function Signup() {
    ...
    return (
        <div style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDFN6OjCNprkitDHEcv9mMJ6VUZ8ySwNe-lg&s")', backgroundSize: 'cover',height: '100vh' }}>
        <div className='container'>
            <form onSubmit={handleSubmit}><b><br/>
            <h2><center><b> Register To TASTE TRIBE</b></center></h2>
